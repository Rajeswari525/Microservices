...
public class AccountsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CustomerDto> fetchCustomerByMobileNumber(@RequestParam
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponseDto> updateAccountData(@Valid @RequestBody CustomerDto customerDto){
    ...
    public ResponseEntity<String> getBuildInfo() throws TimeoutException {
        ...
        throw new TimeoutException("Exception from getBuildInfo()");
//        return ResponseEntity.status(HttpStatus.OK)
//                .body(buildVersion);
    }
