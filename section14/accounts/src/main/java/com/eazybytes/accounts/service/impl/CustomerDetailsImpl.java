...
public class CustomerDetailsImpl implements ICustomerDetailsService {
    ...
    public CustomerDetailsDto fetchCustomerDetails(String correlationId, String mobileNumber) {
        ...
        customerDetailsDto.setCardsDto((cardsFeignClient.fetchCard(correlationId, mobileNumber)!=null)?(cardsFeignClient.fetchCard(correlationId, mobileNumber).getBody()):null);
        customerDetailsDto.setLoansDto((loansFeignClient.fetchLoan(correlationId, mobileNumber)!=null)?(loansFeignClient.fetchLoan(correlationId, mobileNumber).getBody()):null);
